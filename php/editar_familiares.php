...
$lista3=$empleado->mostrar_familiar_jefe(@$_SESSION['cod_admin']);
?>
...
/*paginacion id de la tabla*/
 ...
 <center>
			<h2>Solicitudes de Cambio de Datos de Familiares por Aprobar o Rechazar</h2>   
				...
				<th width="9%" scope="col">Cargo</th>
			      ...
			      <td><?php echo utf8_decode($lista3[$i]['cargo']); ?></td>
                              <td><a href="#" id="editar" onclick="modal_iframe('form_familiar.php?cod=<?php echo $lista3[$i]["codigo"];?>&ced=<?php echo $lista3[$i]["cedula2"];?>','Responder Solicitud de Datos Familiares',false,false,event);">Ver</a></td>
