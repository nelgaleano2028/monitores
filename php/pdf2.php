...
$qry6="select * from certificado_rtefte where ano='2011'";
...
<div style="position:absolute; top:114px; left:255px; font-size:11px"><p>'.@$pri_apellido.'</p></div>
<div style="position:absolute; top:114px; left:370px; font-size:11px"><p>'.@$seg_apellido.'</p></div>

<div style="position:absolute; top:114px; left:490px; font-size:11px"><p>'.@$pri_nombre.'</p></div>
<div style="position:absolute; top:114px; left:600px; font-size:11px"><p>'.@$seg_nombre.'</p></div>
...
<div style="position:absolute; top:854px; left:313px; font-size:7px; color:gray; font-weight:bold"><p>a Diciembre 31 de 2011</p></div>
