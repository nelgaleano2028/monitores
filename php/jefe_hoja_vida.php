...
$lista3=$empleado->mostrar_hoja_vida_jefe(@$_SESSION['cod_admin']);
?>
...
function modal_iframe(url,title,a,b,e){
 ...
 <center>
			<h2>Solicitudes de Cambio de Datos de Hoja de Vida por Aprobar o Rechazar</h2>   
				...
				<th width="9%" scope="col">Cargo</th>
			      ...
			      <td><?php echo utf8_decode($lista3[$i]['cargo']); ?></td>
                              <td><a href="#" id="editar" onclick="modal_iframe('form_hoja_vida.php?cod=<?php echo $lista3[$i]["codigo"];?>','Responder Solicitud de hoja de vida',false,false,event);">Ver</a></td>
